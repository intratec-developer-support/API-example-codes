Public Function UC_series_values(accessToken As String) As String
    ...
    'This is the URL to the Water & Utility Costs - Sandbox - Series Values operation:
    ...
    'Make a GET request to the Water & Utility Costs - Sandbox - Series Values operation
    ...
    'Get the response
    UC_series_values = request.responseText
