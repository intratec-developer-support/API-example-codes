Public Function IE_CI_series_values(accessToken As String) As String
    ...
    'This is the URL to the Industry Economics Worldwide - Plant Construction Cost Indexes - Sandbox - Series Values operation:
    ...
    'Make a GET request to the Industry Economics Worldwide - Plant Construction Cost Indexes - Sandbox - Series Values operation
    ...
    'Get the response
    IE_CI_series_values = request.responseText
