Public Function IE_UC_series_values_hist(accessToken As String) As String
    ...
    'This is the URL to the Industry Economics Worldwide - Industrial Utilities Prices & Costs - Sandbox - Series Values History operation:
    ...
    'Make a GET request to the Industry Economics Worldwide - Industrial Utilities Prices & Costs - Sandbox - Series Values History operation
    ...
    'Get the response
    IE_UC_series_values_hist = request.responseText
