Public Function IE_series_values_hist(accessToken As String) As String
    ...
    'Available codes are obtained via **Intratec Industry Economics Worldwide - Series Info operation**. Note: You can use codes from the previous IEW API versions.
    ...
    'This is the URL to the Industry Economics Worldwide - Sandbox - Series Values History operation:
    'To query actual values, simply remove sandbox/ from the URL
    url = "https://intratec.azure-api.net/industry_economics/v1/sandbox/export/series_hist/" & codes

    'Set up the request
    Dim request As Object
    Set request = CreateObject("MSXML2.ServerXMLHTTP")
    
    'Make a GET request to the Industry Economics Worldwide - Sandbox - Series Values History operation
    ...
    'Get the response
    IE_series_values_hist = request.responseText
