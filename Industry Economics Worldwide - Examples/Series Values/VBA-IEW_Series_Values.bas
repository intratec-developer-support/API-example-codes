Public Function IE_series_values(accessToken As String) As String
    ...
    'This is the URL to the Industry Economics Worldwide - Sandbox - Series Values operation:
    'To query actual values, simply remove sandbox/ from the URL
    url = "https://intratec.azure-api.net/industry_economics/v1/sandbox/export/series/" & codes

    'Set up the request
    Dim request As Object
    Set request = CreateObject("MSXML2.ServerXMLHTTP")
    
    'Make a GET request to the Industry Economics Worldwide - Sandbox - Series Values operation
    ...
    'Get the response
    IE_series_values = request.responseText
