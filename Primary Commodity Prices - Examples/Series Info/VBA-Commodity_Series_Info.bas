Public Function CP_series_info(accessToken As String) As String
    ...
    'This is the URL to the Primary Commodity Prices - Sandbox - Series Info operation:
    ...
    'Make a GET request to the Primary Commodity Prices - Sandbox - Series Info operation
