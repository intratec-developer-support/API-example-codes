Public Function CP_sb_series_values(accessToken As String) As String
    ...
    url = "https://intratec.azure-api.net/commodity_price/v1/sandbox/export/series-hist/" & codes

    'Set up the request
    Dim request As Object
    Set request = CreateObject("MSXML2.ServerXMLHTTP")
    
    'Make a GET request to the Primary Commodity Prices - Series Values History API
