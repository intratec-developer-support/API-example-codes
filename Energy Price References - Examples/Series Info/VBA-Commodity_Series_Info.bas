Public Function EP_series_info(accessToken As String) As String
    ...
    'This is the URL to the Energy Price References - Sandbox - Series Info operation:
    ...
    'Make a GET request to the Energy Price References - Sandbox - Series Info operation
